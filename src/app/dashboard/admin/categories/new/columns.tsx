/**
 * Categories Table Columns Configuration
 * 
 * This file defines the column structure for the categories data table.
 * It uses TanStack React Table to create a table with columns for displaying
 * category information and action buttons.
 * 
 * Key Features:
 * - Displays category image, name, URL, and featured status
 * - Provides edit and delete actions via dropdown menu
 * - Uses modals for editing and confirmation dialogs for deletion
 * 
 * Note: This is similar to subcategories columns but for categories (parent entities)
 */
...
export const columns: ColumnDef<Category>[] = [
    /**
     * Image Column
     * Displays the category's image as a circular thumbnail
    ...
    /**
     * Name Column
     * Displays the category name with bold, capitalized styling
     */
    {
        accessorKey: "name",
        header: "Name",
    ...
    /**
     * URL Column
     * Displays the category's URL slug with a leading slash
 ...
 * Receives the full row data for the category being acted upon
 */
 ...
 * - Opening a modal to edit category details
        ...
        <AlertDialog>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    {/* Edit action - opens modal with category form */}
                    <DropdownMenuItem
                        className="flex gap-2"
                        onClick={() => {
                            /**
                             * Opens a modal with the CategoryDetails form component
                            ...
                            setOpen(
                                ...
                                <CustomModal>
                                    {/* Category form component with existing data */}
                                    <CategoryDetails data={{ ...rowData }} />
                                </CustomModal>,
                                async () => {
                                    // Fetch fresh category data when modal opens
                                    return {
